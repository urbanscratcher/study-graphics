...
function setupDominoes() {
  ...
  // create a stack of dominoes (vetically long retangular shape) in line. The bottom of a domino should be placed on the small ground.
  stack = Composites.stack(150, 300, 30, 1, 20, 0, function (x, y) {
