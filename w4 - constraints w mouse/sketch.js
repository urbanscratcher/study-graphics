let { Engine, World, Bodies, Render, Constraint, MouseConstraint, Mouse } =
  Matter;
let canvas;
...
function setup() {
  ...
  // Mouse
  // pass the HTML canvas element to the Mouse.create function
  // to catch the position of the mouse pointer relative to the canvas
  let mouse = Mouse.create(canvas.elt);
  let mouseParams = {
    mouse: mouse,
  };
  mouseConstraint = MouseConstraint.create(engine, mouseParams);
  mouseConstraint.mouse.pixelRatio = pixelDensity(); // for higher resolution screens
